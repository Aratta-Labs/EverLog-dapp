...
import evervotelogo from './../assets/evervote-logo.jpg'
...
export const loader = async () => {
  return defer({
    tour: [
      {
        title: 'EverVote',
        description: 'EverVote is a platform for users to create polls and also vote on them with their Universal Profiles on LUKSO blockchain',
      },
      {
        title: 'You need 🆙',
              ...
              {data
                ...
                .map((item, b) => (
                  <div className="d-flex flex-column align-items-center justify-content-center animate__animated animate__fadeIn" key={b}>
                    {activeTour === 0 && <img src={evervotelogo} style={{height: '200px'}}/>}
                    <b>{item.title}</b>
