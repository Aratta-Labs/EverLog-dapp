...
const data = [
  {
    q: 'What is EverVote?',
    a: 'The EverVote on-chain pools creator provides a secure and verifiable way of voting within the framework of the DAOs governance system on LUKSO.',
  },
  {
    q: 'How does it work?',
